...
# NEW IMPORTS - only change these lines!
...
class LadesaeulenregisterLoader:
    ...
    def __init__(self):
        ...
        self.csv_path = Path("contexts/shared_kernel/datasets/Ladesaeulenregister.csv")
    ...
    def load_berlin_stations(self) -> List[OperationalStation]:
