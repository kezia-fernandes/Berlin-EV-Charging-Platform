...
from ..value_objects.station_status import StationStatus  # or from shared_kernel if you put it there


class OperationalStation:  # Renamed from ChargingStation
    """Entity: Operational Charging Station"""
